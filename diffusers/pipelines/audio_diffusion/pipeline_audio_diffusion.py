...
class AudioDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        encoding_motion: torch.Tensor = None,
        encoding_neg: torch.Tensor = None,
        encoding_motion_neg: torch.Tensor = None,
        return_dict=True,
    ) -> Union[
        ...
        for step, t in enumerate(self.progress_bar(self.scheduler.timesteps[start_step:])):
            if isinstance(self.unet, UNet2DConditionModel):
                ...
                model_output = self.unet(images, t, encoding,encoding_motion,encoding_neg,encoding_motion_neg)["sample"]
            else:
